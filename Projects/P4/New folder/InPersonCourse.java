...
/**
 * This is a concrete class that inherits from LectureCourse and represents in-person courses.
 * @author Justin Vu
...
public class InPersonCourse extends LectureCourse {
    ...
    /**
     * InPersonCourse constructor calls the parent class constructor with the given arguments.
